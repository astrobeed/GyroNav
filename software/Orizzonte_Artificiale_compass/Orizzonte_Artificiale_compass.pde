...
int W=1300; //screen width 
int H=700;  //sreen height 
float Pitch; 
float Bank; 
float Azimuth; 
...
{ 
  ...
  //Shows your connected serial ports
  println(Serial.list());
  
  // get the second available port (use EITHER this OR the specific port code below)
...
{ 
  ...
  textSize(40);
  fill(25,25,150);
  text("MPU6050 Data", -350, 477, 500, 60); 
}
void Compass() 
{ 
  translate(2*W/3, 0); 
